...
/***/ function(module, exports, __webpack_require__) {
	...
	hamburgerMenu('.hamburger-menu', '.menu', '.logo', '.header');
...
/***/ function(module, exports) {
	...
	var hamburgerMenu = function(triggerID, menuID, logoID, headerID) {
	  ...
	  function clickTrigger(event) {
	    ...
	    toggleClass(logo, logoID);
	    toggleClass(header, headerID);
	    toggleClass(body, 'mmenu');
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	// 1. Initially we have all three devices stacked up
	// 2. Tablet and mobile is pushed down
	// 3. On scroll tablet and mobile is stacking up on the laptop
	function Hero() {
	  ...
	  // Save tablet and phone positions
	  this.phoneTransformY = getElementTransform(this.phone, 'Y');
	  this.tabletTransformY = getElementTransform(this.tablet, 'Y');

	  // Push down tablet and phone
	  this.transform(this.tablet, 0, this.tabletTransformY + vhToPx(50));
	  this.transform(this.phone, 0, this.phoneTransformY + vhToPx(50));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Slider2(sliderID, step, callback) {
	  ...
	  // make CSS transforms (in em) to Javascript transforms (in px)
	  // - otherwise on the first left slide everything will mess up
	  this.cssTransformsToJS();
	}


	// Setup slides, even newly inserted ones
	// - for values which change after new items are inserted
	...
	// Setup slides, at initialization
	// - for values which stay constant
	...
	// Make CSS transforms (in em) to Javascript transforms (in px)
	Slider2.prototype.cssTransformsToJS = function() {

	  this.slides.loop(function(slide) {
	    var currentTransform = getElementTransform(slide, 'X');
	    var t = 'translateX(' + currentTransform + 'px)';
	    transform(slide, t, t);
	  });
	}
	...
	var slider2 = function(sliderID, step, callback) {
	  ...
	  // On window resize re-calculate thumbnail positions
	  /*
	  window.addEventListener('resize',
	    _.throttle(_.bind(s.slide(1), s), 300)
	  );
	  */
	}
	...
	Slider2.prototype.slide = function(direction) {
	  ...
	  _this.slides.loop(function(slide) {
	    var currentTransform = getElementTransform(slide, 'X');
	    var newTransform = currentTransform + (direction * _this.slideWidth * _this.step);
	...
	Slider2.prototype.checkInfinite = function(direction) {
	  ...
	  _this.canNavigateLeft = (offset + firstSlideTransform  < 0);
	...
	Slider2.prototype.makeInfinite = function(direction) {
	  ...
	  if ((!_this.canNavigateLeft) && (direction == 1)) {
	    ...
	    currentSlide = 0;
	    currentTransform = getElementTransform(_this.slides[0], 'X') - _this.transformX * (_this.slideCount + 2);
	    reArrange = true;
	  }
	...
	Slider2.prototype.arrangeSlides = function(currentSlide, currentTransform) {
	  ...
	  for (var i = currentSlide; i <= (currentSlide + _this.slideCount); i++) {
	    var newTransform = currentTransform +  _this.transformX;
	    var t = 'translateX(' + newTransform + 'px)';
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	// 1. At initial state image, specs etc are translated down to ipad
	...
	RichMediaHero.prototype.scroll = function(event) {
	  ...
	  // Translate Y
	  this.transform(this.image, this.imageTransformX, imageY, this.imageTransformScale);
	  this.transform(this.specs, this.specsTransformX, specsY, this.specsTransformScale);
	  this.transform(this.icon, this.iconTransformX, iconY, this.iconTransformScale);
	...
	RichMediaHero.prototype.setInitialState = function() {
	  this.transform(this.image, this.imageTransformX, 0, this.imageTransformScale);
	  this.transform(this.specs, this.specsTransformX, 0, this.specsTransformScale);
	  this.transform(this.icon, this.iconTransformX, 0, this.iconTransformScale);
	...
	RichMediaHero.prototype.setAfterState = function() {
	  this.transform(this.image, this.imageTransformX, this.imageTransformY, this.imageTransformScale);
	  this.transform(this.specs, this.specsTransformX, this.specsTransformY, this.specsTransformScale);
	  this.transform(this.icon, this.iconTransformX, this.iconTransformY, this.iconTransformScale);
	...
	//
	RichMediaHero.prototype.transform = function(element, x, y, scale) {
	  var t = 'translateY(' + y + 'px) translateX(' + x+ 'px) scale(' + scale + ')';
	  transform(element, t, t);
	}
...
/***/ function(module, exports) {
	...
	var filter = function(type, filtersID, itemsID) {
	  ...
	  function clickFilter(event) {
	    ...
	    markAllInactive(filters, 'filter--inactive');
	  ...
	  // Remove 'klass' class from a series of DOM elements
